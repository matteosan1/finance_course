...
However, it will be helpful for later usage to modify the denominator, $P(B)$ on the right hand side to be written in terms of $P(B|A)$. We can actually write (\emph{law of total probability}):
\begin{equation}
