...
You can download the dateset with \texttt{yfinance} as in the following code or to
...
w = np.array([0.6, 0.4])
df['AAPL_rets'] = df['AAPL']/df['AAPL'].shift(1) - 1
df['NFLX_rets'] = df['NFLX']/df['NFLX'].shift(1) - 1
...
As in the previous case if we are interested in a longer time horizon we can use Eq.~\ref{eq:var_horizon}.
