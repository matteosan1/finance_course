...
\title{Financial Markets - Exercises}
\author{Matteo Sani \\ Staff Quants - MPS Capital Services \\\href{mailto:matteo.sani@mpscapitalservices.it}{matteo.sani@mpscapitalservices.it}}     
...
\maketitle
\input{exercises_1.tex}
\clearpage
\input{exercises_2.tex}
\clearpage
\input{exercises_3.tex}
\clearpage
\input{exercises_4.tex}
\clearpage
\input{exercises_5.tex}
\clearpage
\input{exercises_6.tex}
\clearpage
\input{exercises_7.tex}
\clearpage
\input{exercises_8.tex}
\clearpage
\input{exercises_9.tex}
\clearpage
