...
\begin{document}
    ...
    \hypertarget{exercise-on-swaps-and-bootstrapping}{%
\section{Exercise on Swaps and
Bootstrapping}\label{exercise-on-swaps-and-bootstrapping}}
...
\PY{n}{obesrvation\PYZus{}date} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{date}\PY{o}{.}\PY{n}{today}\PY{p}{(}\PY{p}{)}
