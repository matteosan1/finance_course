...
Take the \texttt{OvernightIndexSwap} class from the lesson and add a new method called \texttt{fair\_value\_strike} which takes a discount curve object and returns the fixed rate which would make the OIS have zero NPV.
...
Finally add this method to the class implementation in \texttt{finmarkets}.
\end{Answer}
