...
\begin{thebibliography}{9}
	\bibitem{bib:datetime} \href{https://realpython.com/python-datetime/}{\emph{https://realpython.com/python-datetime/}}, Real Python, Using Python datetime to Work With Dates and Times [Online]
\end{thebibliography}