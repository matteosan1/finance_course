...
In probability theory in general, a random variable is formalized as a
...
When the range of possible values for \(X\) is uncountably infinite then \(X\) 
...
In the context of discrete random variables the probability density function is usually referred to \emph{probability mass function}.
...
Any random variable can be conveniently described by its cumulative distribution too.
