...
This is just an example, actually is sort of an overkill to use inheritance here, since there is not much of code to share between the classes (the implementation of the npv calculation is different in each of them).
Anyway this is a practical application to show how it works.

>>>>>>> a3529626a21006e33f76fcada45c64091e6856ad
