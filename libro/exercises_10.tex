...
\begin{Exercise}
Using the above \texttt{Credit\ Curve} and the \texttt{DiscountCurve} already defined from \href{https://drive.google.com/file/d/1mugHyet3H9tcSAvYvt8G4_kpfaEbVY7b/view?usp=sharing}{discount\_curve\_ch10.xlsx}, price the following CDS:
