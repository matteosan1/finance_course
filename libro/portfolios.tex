...
\label{sec:capm}
The Capital Asset Pricing Model (CAPM) describes the relationship between asset expected returns and \emph{systematic risk} of the market.
...
\subsection{Calculate $\beta$ for a Stock}
...
These quantities can be calculated with \texttt{numpy.polyfit} passing as inputs market and stock return lists. 
...
\subsection{Calculate $\beta$ for a Portfolio}
