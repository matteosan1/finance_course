...
To reach this goal it is essential to have reliable models to describe the 
evolution of the interest rate with time.

In this Chapter the most common interest rate modeling techniques are reviewed
together with related \texttt{python} applications.

\section{Short Rate Models}
Bond, option and other derivative prices
depend only on the process followed by \(r\) in a risk neutral world.
Let $Z(R, t, T)$ be the price of a zero coupon bond with maturity $T$ at time $t$. 
It defines the corresponding interest rate $R(T)$ by the formula
...
Zero-coupon yield curve, also called term structure of interest rates, is then
formed by interest rates with different maturities
...
\emph{instantaneous short rate}). 
It can be seen as the beginning of the yield curve: 
...
Usually the risk-neutral process for the short rate is described by a SDE analogous 
to Eq.~\ref{eq:short_rate_sde} where
\(\theta\), \(\alpha\) and $\sigma$ are assumed to be function of \(r\) but independent of time.

A subset of such models, called \emph{one-factor equilibrium models},
is made of those whose process for \(r\) involves only
one source of uncertainty (i.e. one stochastic term). 

One factor models are essentially assuming that the dynamics of the whole term structure is 
captured by the short rate, and its future evolution. Nevertheless, 
...
\emph{mean reversion}. When \(r\) is high, mean reversion tends to 
cause it to have a negative drift; when \(r\) is low,
...
The Vasicek model incorporates this feature (the
short rate is pulled to a level \(\theta\) at a rate \(k\)), which is a good
property, but interest rates can go negative, which instead is a very bad property.

In the following code it has been implemented a \texttt{VasicekModel} class which 
implements the process described by Eq.~\ref{eq:vasicek_process}.
...
\PY{k}{class} \PY{n+nc}{VasicekModel}\PY{p}{:}
    \PY{k}{def} \PY{n+nf+fm}{\PYZus{}\PYZus{}init\PYZus{}\PYZus{}}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{k}\PY{p}{,} \PY{n}{theta}\PY{p}{,} \PY{n}{sigma}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{def} \PY{n+nf}{r\PYZus{}generator}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{r0}\PY{p}{,} \PY{n}{t}\PY{p}{,} \PY{n}{T}\PY{p}{,} \PY{n}{N}\PY{p}{)}\PY{p}{:}
        \PY{n}{r} \PY{o}{=} \PY{p}{[}\PY{n}{r0}\PY{p}{]}
        \PY{n}{dt} \PY{o}{=} \PY{p}{(}\PY{n}{T}\PY{o}{\PYZhy{}}\PY{n}{t}\PY{p}{)}\PY{o}{/}\PY{n+nb}{float}\PY{p}{(}\PY{n}{N}\PY{p}{)}
        \PY{k}{for} \PY{n}{\PYZus{}} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{N}\PY{p}{)}\PY{p}{:} 
            \PY{n}{r\PYZus{}new} \PY{o}{=} \PY{n}{r}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{+} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{k}\PY{o}{*}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{theta} \PY{o}{\PYZhy{}} \PY{n}{r}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{o}{*}\PY{n}{dt} \PY{o}{+} 
                    \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sigma}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{normal}\PY{p}{(}\PY{p}{)}
            \PY{n}{r}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{r\PYZus{}new}\PY{p}{)}
        \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n}{t}\PY{p}{,} \PY{n}{T}\PY{o}{+}\PY{n}{dt}\PY{p}{,} \PY{n}{dt}\PY{p}{)}\PY{p}{,} \PY{n}{r}

\PY{n}{v} \PY{o}{=} \PY{n}{VasicekModel}\PY{p}{(}\PY{l+m+mf}{0.02}\PY{p}{,} \PY{l+m+mf}{0.5}\PY{p}{,} \PY{l+m+mf}{0.02}\PY{p}{)}
\PY{n}{t}\PY{p}{,} \PY{n}{rs} \PY{o}{=} \PY{n}{v}\PY{o}{.}\PY{n}{r\PYZus{}generator}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{,} \PY{l+m+mi}{200}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

Figure~\ref{fig:vasicek_path} shows just one simulation to observe what the short rate from the Vasicek model will look like. 
...
In the following code we have extended the \texttt{VasicekModel} class with two new methods 
that compute the zero coupon bound price and the evolution of the interest rate for the 
term $\tau$ as described by Equations~\ref{eq:zcb_vasicek} and~\ref{eq:term_structure_vasicek}.
...
\PY{k}{class} \PY{n+nc}{VasicekModel}\PY{p}{:}
    ...
    \PY{k}{def} \PY{n+nf}{ZCB}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{tau}\PY{p}{,} \PY{n}{r0}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{:}
        \PY{n}{B} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{np}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{k}\PY{o}{*}\PY{n}{tau}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{k}
        \PY{n}{A} \PY{o}{=} \PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{theta}\PY{o}{*}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{k}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{\PYZhy{}}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sigma}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{k}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)} \PY{o}{*} \PYZbs{}
            \PY{p}{(}\PY{n}{B}\PY{o}{\PYZhy{}}\PY{n}{tau}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sigma}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{l+m+mi}{4}\PY{o}{*}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{k}\PY{p}{)}\PY{o}{*}\PY{p}{(}\PY{n}{B}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}
        \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{n}{A}\PY{o}{\PYZhy{}}\PY{n}{r0}\PY{o}{*}\PY{n}{B}\PY{p}{)}

    \PY{k}{def} \PY{n+nf}{R}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{r0}\PY{p}{,} \PY{n}{t}\PY{p}{,} \PY{n}{tau}\PY{p}{,} \PY{n}{N}\PY{p}{)}\PY{p}{:}
        \PY{n}{x}\PY{p}{,} \PY{n}{r} \PY{o}{=} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{r\PYZus{}generator}\PY{p}{(}\PY{n}{r0}\PY{p}{,} \PY{n}{t}\PY{p}{,} \PY{n}{t}\PY{o}{+}\PY{n}{tau}\PY{p}{,} \PY{n}{N}\PY{p}{)}
        ...
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
            \PY{n}{tau} \PY{o}{=} \PY{n}{x}\PY{p}{[}\PY{n}{i}\PY{p}{]}
            \PY{n}{B} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{np}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{k}\PY{o}{*}\PY{n}{tau}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{k}
            \PY{n}{A} \PY{o}{=} \PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{theta}\PY{o}{*}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{k}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{\PYZhy{}}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sigma}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{k}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)} \PY{o}{*} \PYZbs{}
                \PY{p}{(}\PY{n}{B}\PY{o}{\PYZhy{}}\PY{n}{tau}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sigma}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{l+m+mi}{4}\PY{o}{*}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{k}\PY{p}{)}\PY{o}{*}\PY{p}{(}\PY{n}{B}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}
            \PY{n}{R}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{n}{tau}\PY{o}{*}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{A}\PY{o}{+}\PY{n}{r}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{*}\PY{n}{B}\PY{p}{)}\PY{p}{)}
        \PY{k}{return} \PY{n}{x}\PY{p}{[}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{R}

\PY{n}{v} \PY{o}{=} \PY{n}{VasicekModel}\PY{p}{(}\PY{l+m+mf}{0.02}\PY{p}{,} \PY{l+m+mf}{0.5}\PY{p}{,} \PY{l+m+mf}{0.02}\PY{p}{)}
\PY{n}{t}\PY{p}{,} \PY{n}{R} \PY{o}{=} \PY{n}{v}\PY{o}{.}\PY{n}{R}\PY{p}{(}\PY{l+m+mf}{0.015}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{50}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

Figure~\ref{fig:term_structure_vasicek} shows the continuously compounded interest rate 
for the term 1 year.
...
Figure~\ref{fig:cir_path} shows just one simulation to observe what the short rate from the CIR model will look like. 
...
%model to fit the initial term structure. 
