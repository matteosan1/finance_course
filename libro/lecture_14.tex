...
As we have seen the whole model is about plotting a line in a scatter plot. It’s not very complex model. Assumptions under the model are even more simplistic. For example:
\begin{itemize}
\tightlist
