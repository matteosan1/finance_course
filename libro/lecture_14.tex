...
\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth]{figures/effiecient_frontier.png}
...
%If the expected excess returns of assets are proportional to their risks (volatilities), then ER(P) = kP′Σ, where
%k is a constant, and maximizing D(P) is equivalent to maximizing , which is the Sharpe ratio of the portfolio.
%In this case, the Most-Diversified Portfolio is also the tangency portfolio
%
%
