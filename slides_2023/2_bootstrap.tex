...
\end{itemize}
\href{https://drive.google.com/file/d/1ZPjDST00jXLR1MIXapcyPaNkW-GMNciA/view?usp=sharing}{\beamergotobutton{OIS Class}}
\end{frame}
...
\end{frame}  
 ...
 \item There are various methods to solve this problem (which is also called root-finding), the simplest being the \emph{bisection method}.
  \end{itemize}
 \href{https://colab.research.google.com/drive/1ZPjDST00jXLR1MIXapcyPaNkW-GMNciA?authuser=1#scrollTo=-lhzjhsfe8Qk\&line=1\&uniqifier=1}{\beamergotobutton{Bisection Method}}
\end{frame} 
...
\begin{frame}{Bootstrap as Minimization Problem}
  ...
  \end{itemize}
 \href{https://colab.research.google.com/drive/1ZPjDST00jXLR1MIXapcyPaNkW-GMNciA?authuser=1\#scrollTo=X-kM9zDOgqDN\&line=1\&uniqifier=1}{\beamergotobutton{Minimization Algorithm}}
\end{frame}
...
we haven't yet identified a constraint on how many points the curve needs to have (\emph{too many or too few points may prevent us from finding the solution}).
 ...
 \end{equation}
\end{itemize}
\href{https://colab.research.google.com/drive/1ZPjDST00jXLR1MIXapcyPaNkW-GMNciA?authuser=1\#scrollTo=I6WBjiG-iZZu\&line=1\&uniqifier=1}{\beamergotobutton{OIS Bootstrap}}
\end{frame} 
